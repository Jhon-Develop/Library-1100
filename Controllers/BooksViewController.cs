...
namespace library_1100.Views.BooksView
{
    public class BooksViewController : Controller
    {
        private readonly ApplicationDbContext _context;

        public BooksViewController(ApplicationDbContext context)
        {
            _context = context;
        }
